...
struct ImagingTopoClusterConfig {
  ...
  // maximum distance of locall (x, y) to be considered as neighbors at same layers (if samelayerMode==xy)
  ...
  std::vector<double> ScFi_sameLayerDistXYZ = {80.0 * dd4hep::mm, 80.0 * dd4hep::mm, 40.0 * dd4hep::mm};
  std::vector<double> Img_sameLayerDistXYZ = {80.0 * dd4hep::mm, 80.0 * dd4hep::mm, 40.0 * dd4hep::mm};
  ...
  std::vector<std::variant<std::string, double>> ScFi_diffLayerDistXY = {1.0 * dd4hep::mm, 1.0 * dd4hep::mm};
  std::vector<std::variant<std::string, double>> Img_diffLayerDistXY = {1.0 * dd4hep::mm, 1.0 * dd4hep::mm};
  ...
  std::vector<double> ScFi_diffLayerDistXYZ = {80.0 * dd4hep::mm, 80.0 * dd4hep::mm, 40.0 * dd4hep::mm};
  std::vector<double> Img_diffLayerDistXYZ = {80.0 * dd4hep::mm, 80.0 * dd4hep::mm, 40.0 * dd4hep::mm};
